...
//    }
    ...
    $('#btn-update-plane').click(function () {
         planes = {1:"midle",2:"fast",3:"very_fast"};
        if(planes[person_profile.MarkInfo.Plane.id]==plane) return;
