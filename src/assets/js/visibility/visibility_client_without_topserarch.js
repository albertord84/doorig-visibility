$(document).ready(function () {
    ...
    function show_profile_in_view(container, profile, id) {
        $.ajax({
            url: base_url+"index.php/welcome/get_person_profile_datas/"+ profile,
            type: 'GET',
            dataType: 'json',
            success: function (response) {                
                ...
                if(response){
                    var str = "<div id='container-" + id + "' class='col-md-4 col-sm-12 col-xs-12'>" +
                            ...
                            "<img class='img-profile' src='" + response.image + "'>" +
                            "<h5 class='card-title'>" +
                            "@" + profile +
                            "</h5>" +
                            "</a>" +
                            ...
                            "<h6 id='amount-folowers-profile' class='text-muted'>" + response.followers + "</h6>" +
                            "</div>" +
                            "</div>" +
                            "</div>" +
                            "</div>" +
    ...
    function show_geolocation_in_view(container, geolocation, id) {
        $.ajax({
            url: base_url+"index.php/welcome/get_geolocation_datas/"+ geolocation,
            type: 'GET',
            dataType: 'json',
            success: function (response) {                
                if(response){                
                    var str = "<div id='container-" + id + "' class='col-md-4 col-sm-12 col-xs-12'>" +
                            ...
                            "<br>" +
                            "<div class='text-center'>" +
                            "<a  href='https://www.instagram.com/explore/locations/" + response.location.pk + "/" + datas.location.slug + "/" + "' target='_blank'>" +                    
    ...
    function show_hashtag_in_view(container, hashtag, id) {
        $.ajax({
            url: base_url+"index.php/welcome/get_hashtag_datas/"+ hashtag,
            type: 'GET',
            dataType: 'json',
            success: function (response) {
