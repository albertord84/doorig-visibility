        ...
        <div class="container sensitive_painel">             
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-6 col-xs-12">
                    <div class="row">       
                        <div class="col-md-6 col-sm-12 col-xs-12  m-top-20 text-center">
                            <h2 class="text-muted pd-10 text-center">AUTOLIKE</h2> 
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12  m-top-20 text-center">
                            <h2 class="text-muted pd-10 text-center"> UNFOLLOW TOTAL</h2> 
                            <div class="card-over-card">
                                <div class="card-body">
                                    <div class="message-box">
                                        <div id="" class="message-widget message-scroll text-center">
