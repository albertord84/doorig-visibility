...
require_once config_item('business-client-class');
    ...
    class Vindi extends Business {
        ...
        function __construct(int $client_id = NULL) {
            ...
            $this->customerService = new \Vindi\Customer($this->api_arguments);
        }
        ...
        public function addClientPayment($client_id, $payment_data) {
            ...
            if ($payment && $payment->status == 'active')
                return Response::ResponseOK();
            return Response::ResponseFAIL(T("Problemas inserindo meio de pagamento"));
        }
