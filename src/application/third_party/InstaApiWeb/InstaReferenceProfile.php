...
namespace InstaApiWeb {
  ...
  abstract class InstaReferenceProfile {     
    ...
    protected $tag_query;
      ...
      protected static function get_insta_data_from_client($ref_prof, Cookies $cookies, $proxy = NULL) {
     ...
     abstract protected function  process_top_prof_data(\stdClass $content);   

     abstract public function get_insta_followers(Cookies $cookies = NULL, int $N = 15, string& $cursor = NULL, Proxy $proxy = NULL);
     ...
     abstract public function get_post_user_info(string $post_reference, Cookies  $cookies = NULL, Proxy $proxy = NULL);
